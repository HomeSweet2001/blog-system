...
export function AboutPage() {
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6">
      ...
      {settings.tagline && (
        <p className="mt-3 text-lg opacity-80">{settings.tagline}</p>
      )}
      ...
      <div className="prose-blog mt-8">
        ...
        <p>
          Para editar este texto, acesse o painel administrativo e ajuste as
          configurações de aparência e identidade do blog.
        </p>
      </div>
      ...
      <EmptyState
        ...
        action={
          <Link to={home} className="btn btn-primary">
            ...
            {blog?.slug ? "Voltar para o inicio" : "Ver todos os blogs"}
          </Link>
        }
      />
    </div>
