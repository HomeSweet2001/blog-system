    ...
    >
      ...
      <div className="flex flex-1 flex-col p-5">
        <div className="flex items-center gap-3">
          {blog.logo_url ? (
            <img src={blog.logo_url} alt="" className="h-9 w-auto max-w-[120px] object-contain" />
          ) : (
            <span
        ...
        <div className="mt-4 flex items-center justify-between text-xs opacity-60">
          <span className="inline-flex items-center gap-1.5">
            ...
            {blog.post_count} {blog.post_count === 1 ? 'publicacao' : 'publicacoes'}
          </span>
          <span
    ...
    <div className="min-h-screen" style={{ background: 'var(--c-bg)', color: 'var(--c-text)' }}>
      <div
        ...
        style={{
          ...
          background: 'linear-gradient(140deg, var(--c-primary), var(--c-secondary) 90%)',
        }}
      >
        <div className="mx-auto max-w-content text-center text-white">
          ...
          <p className="mx-auto mt-3 max-w-xl text-sm opacity-90 sm:text-base">
            Escolha um blog para ler. Cada um tem sua propria identidade, categorias e publicacoes.
          </p>
        </div>
      </div>
      ...
      <div className="mx-auto max-w-content px-4 py-12 sm:px-6">
        {error ? (
          <EmptyState icon={BookOpen} title="Nao foi possivel carregar" description={error} />
        ) : blogs.length === 0 ? (
          <EmptyState
            icon={BookOpen}
        ...
        <div className="mt-12 text-center">
          <Link to="/admin" className="inline-flex items-center gap-2 text-sm font-semibold underline opacity-60 hover:opacity-100">
